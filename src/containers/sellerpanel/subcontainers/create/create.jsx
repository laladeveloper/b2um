...
const Create = () => {
  ...
  const createlist = async (e) => {
    ...
    try {
      ...
      //await dispatch(newProduct(name, category, description, price, stock));
      // navigate("/"); // You might want to uncomment this if you have the navigate function
    } catch (error) {
     // console.error("Listing creation failed:", error);
      setListingError("Listing creation failed: ", error);
    }
  };
  ...
  return (
    <div className="create">
      ...
      {listingError && (
        <p style={{ color: "red", textAlign: "center" }}>{listingError}</p>
      )}
